...
<template>
    <div class="space-y-6">
        <HeadingSmall title="Elimina account" description="Elimina il tuo account e tutte le sue risorse" />
                ...
                <DialogContent>
                    <form class="space-y-6" @submit="deleteUser">
                        <DialogHeader class="space-y-3">
                            ...
                            <DialogDescription>
                                Una volta eliminato il tuo account, tutte le sue risorse e dati saranno eliminati definitivamente. Inserisci la tua
